...
Original file is located at
    https://colab.research.google.com/drive/1uv26RnIRwgnrp3kOcFgMm8aa99oTRa4O

<a href="https://colab.research.google.com/github/khushipr/Sampling/blob/main/Sampling.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
models = ["Logistic Regression","Decision Tree","SVM","Gaussian Naive Bayes","KNN"]
...
"""On comparison, we can see that when we apply `Decision Tree Algorithm` on `Simple Random Sampling`, we get the highest accuracy."""